...
if ENV_PROFILE == "production":
    ...
    BROKER_URL = 'redis://192.168.120.201:6379/5'
    CELERY_RESULT_BACKEND = 'django-db'
    CELERY_BROKER_URL = 'redis://192.168.120.201:6379/6'
else:
    BROKER_URL = 'redis://192.168.120.201:6379/7'
    CELERY_RESULT_BACKEND = 'django-db'
    CELERY_BROKER_URL = 'redis://192.168.120.201:6379/8'
...
CACHES = {
    'default': {
        ...
        'LOCATION': BASE_DIR,  # 缓存到硬盘（此处设置为保存缓存到桌面）
    }
}
# 缓存配置
# CACHES = {
...
#         "LOCATION": "redis://192.168.120.232:6379",
#         "OPTIONS": {
...
DATABASE_ROUTERS = ['server.database_router.DatabaseAppsRouter']
DATABASE_APPS_MAPPING = {'django_celery_beat': 'qc', 'django_celery_results': 'qc', 'qc': 'qc'}
